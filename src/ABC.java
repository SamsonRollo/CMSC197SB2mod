...
class ABC extends Thread{
	...
	private int type = 0; //penalty function type; 1 = S-P w/o sub, 2 = S-P w/ sub, def = missing

	public ABC(PrintResult printer, int[][][] problem,int employedSize, int onlookerSize, int maxCycle, int penaltyType){

		//Setting of parameters
		this.type = penaltyType;
	...
	private void initialization(){
		...
		for(int ctr=0; ctr<employedSize; ctr++){
			...
			bee[ctr].setFitness(fit.calculateFitness(bee[ctr].getPenaltyValue(type)));
			}
	...
	protected void setPenaltyFunctionType(int type){
		this.type = type;
	}
