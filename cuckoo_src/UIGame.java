...
public class UIGame extends generalPanel{
	...
	private void gameButtons(){
		...
		newGame=addButton(panel[0], "img/game/new.png", "img/game/h_new.png",580,110);
		solve=addButton(panel[0], "img/game/solve.png", "img/game/h_solve.png",620,225);
		options=addButton(panel[0], "img/game/options.png", "img/game/h_options.png",605,315);
		help=addButton(panel[0], "img/game/help.png", "img/game/h_help.png",630,410);
		exit=addButton(panel[0], "img/game/exit.png", "img/game/h_exit.png",625,525);
