...
public class generalPanel{
	...
	public generalPanel(Container container){
		...
		play=addButton(panel[7], "img/main/play.png", "img/main/h_play.png",315,220);
		open=addButton(panel[7], "img/main/open.png", "img/main/h_open.png",430,285);
		create=addButton(panel[7], "img/main/create.png", "img/main/h_create.png",210,285);
		options=addButton(panel[7], "img/main/options.png", "img/main/h_options.png",192,385);
		help=addButton(panel[7], "img/main/help.png", "img/main/h_help.png", 320,325);
		exit=addButton(panel[7], "img/main/exit.png", "img/main/h_exit.png", 430,370);
	...
	protected void setVisible(int num){
		...
		if(num!=-1 && num!=-2) //sets the panel visible 
